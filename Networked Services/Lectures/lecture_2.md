...
- [Networked Services: 1.2](#networked-services-12)
  ...
  - [Labs](#labs)
    - [Permissions](#permissions)
      - [Question 2: Octal Code](#question-2-octal-code)
      - [Question 3: Other Permissions](#question-3-other-permissions)
      - [Question 4: Remove read and execute](#question-4-remove-read-and-execute)
      - [Question 5: Impact of no rx](#question-5-impact-of-no-rx)
      - [Question 6: Add read](#question-6-add-read)
      - [Question 7: Impact of no x](#question-7-impact-of-no-x)
      - [Question 8: Add execute](#question-8-add-execute)
      - [Question 9: umask](#question-9-umask)
    - [Pipes](#pipes)
      - [Question 2: sort](#question-2-sort)
      - [Question 3: reverse sort](#question-3-reverse-sort)
      - [Question 4: sort on a field](#question-4-sort-on-a-field)
      - [Question 5: sort with field separator](#question-5-sort-with-field-separator)
      - [Question 6: using grep](#question-6-using-grep)
      - [Question 7: count with grep](#question-7-count-with-grep)
      - [Question 8: negative grep](#question-8-negative-grep)
      - [Question 9: grep and ls](#question-9-grep-and-ls)
      - [Question 10: ls grep and sort](#question-10-ls-grep-and-sort)
      - [Question 11: find root files](#question-11-find-root-files)
